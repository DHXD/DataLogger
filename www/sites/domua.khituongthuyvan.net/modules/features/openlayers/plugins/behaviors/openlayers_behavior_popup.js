...
Drupal.theme.prototype.openlayersPopup = function(feature) {
  ...
  //if (feature.attributes.description) {
    ...
    output += '<div class="menu"><ul>';
		...
		//output += '<li><a title="Hotline">Hotline: '+feature.attributes.field_station_sim_number+'</a></li>';
		output += '</ul>';
		...
		output += '<li><a title="Điện áp ngắt: '+feature.attributes.field_station_power+'V">Điện áp ngắt: <b>'+feature.attributes.field_station_power+'V</b></a></li>';
		output += '<li><a title="Điện áp phóng: '+feature.attributes.field_station_power+'V">Điện áp phóng: <b>'+feature.attributes.field_station_power+'V</b></a></li></ul>';
		output += '<!--[if lte IE 6]></td></tr></table></a><![endif]-->';
		output += '</li>';
